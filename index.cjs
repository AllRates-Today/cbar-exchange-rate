'use strict';
// Central Bank of Azerbaijan exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/cbar';
...
/** Latest rate for one pair, e.g. getRate('USD', 'AZN', { apiKey }). */
